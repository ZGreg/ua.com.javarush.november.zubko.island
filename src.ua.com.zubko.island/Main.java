...
//        Goat goat = new Goat(6, 5, 1);
//        goat.setCurrentSatiety(0);
//        goat.eat(location);
...
//        Island islandArrayListVersion = new Island();
//        List<Location> island = islandArrayListVersion.getIsland();
//        Animal rabbit = islandArrayListVersion.getLocationById(1).getAnimals().get("Rabbit").remove();
//        rabbit.move(islandArrayListVersion.getLocationById(1), islandArrayListVersion);
//        rabbit.reproduce(islandArrayListVersion.getLocationById(1));
//
//
//        Location location = new Location(1, 1);
//        LocationInfoPrinter locationInfoPrinter = new LocationInfoPrinter();
//        locationInfoPrinter.printLocationInfo(location);
//        Duck duck = new Duck(1, 10, 1);
//        duck.setCurrentSatiety(5);
//       location.getPlants().clear();
//       location.getAnimals().clear();
//        duck.eat(location);
    }
